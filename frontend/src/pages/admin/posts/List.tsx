        ...
        <DashboardLayout>
            <section className="container">
                ...
                <p className="text-sm text-wild-text-grey my-3">
                    Bienvenue dans votre tableau de bord des articles.
                    Ici, vous pouvez consulter tous vos articles, voir leur statut de publication, et suivre leur évolution dans le temps. <br />Utilisez le bouton " Créer un article" pour ajouter de nouveaux contenus et gérer facilement vos publications.  
                </p>  
            </section>
            <section>
